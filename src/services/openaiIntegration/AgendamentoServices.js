...
Instruções: "Ao finalizar a resposta do usuário, você deve lembrar o usuário de acessar o link para cadastro que foi enviado anteriormente para que o usuário possa agendar uma consulta."`;
      }
...
Instruções: "Ao finalizar a resposta do usuário, você deve lembrar o usuário de acessar o link para acessar o calendário que foi enviado anteriormente para que o usuário possa agendar uma consulta."`;
      }
      const response = await this.openaiintegrationservices.assistant(this.lead_id, text, assistant_id);
      return { code: 200, message: 'Mensagem do assistente enviada com sucesso', ...response };
