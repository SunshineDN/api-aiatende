...
6 - Restringir apenas duas opções de datas e horários para demonstração de escassez, e considerar apresentar horários entre 6 horas e 72 horas após ${date} GMT-3, mas sempre oferecer um horário ao usuário;
